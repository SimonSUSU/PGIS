...
K.options = {
	...
	syncType : 'form',
	pasteType : 1,	/* simonsu: 禁止粘贴=0, 纯文本粘贴1, HTML粘贴2 */
	...
	minChangeSize : 50,
	zIndex : 811213,
	uploadpath : 'home/ajaxupload/0/2',	//simonsu 2018-03-15 用于自定义编辑器的上传路径,这个是默认的
	/* simonsu 2013-03-17
	items : [
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'	height:100px;',
		'}',
		'.ke-content p{text-indent:2em; margin:0 0 10px 0;}',	//simonsu add 2012/6/13
		'.ke-content img{max-width:96%;}',	//simonsu add 2012/6/13
		'img.ke-rm {',
		'	border:1px solid #AAA;',
...
function KEditor(options) {
	...
	//simonsu 2015-06-09 注解掉这个判断，解决在手机中打开编辑器时，自动切换到代码模式，造成普遍用户看到HTML代码。
...
function _create(expr, options) {
	...
	options.uploadJson = _undef(options.uploadpath, '/home/ajaxupload/0/2');
	//options.uploadJson = '/home/ajaxupload/0/2';//调用上传文件的方法
