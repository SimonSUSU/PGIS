...
function mapInit(){
    var map = new AMap.Map("container",{
        ...
        //rotation: 90,
        zoom: 18,//初始地图级别
        center: [110.319142,20.038157], //初始地图中心点
    ...
    var circle = new AMap.Circle({
        center: new AMap.LngLat(110.319142,20.038157),// 圆心位置
    ...
    var circle2 = new AMap.Circle({
        center: new AMap.LngLat(110.369432,20.026731),// 圆心位置
        radius: 3000, //圆半径，单位:米
        fillColor: '#ff0000',   // 圆形填充颜色,使用16进制颜色代码赋值。默认值为#006600
        fillOpacity:0, //圆形填充透明度，取值范围[0,1]，0表示完全透明，1表示不透明。默认为0.9
    ...
    var circle3 = new AMap.Circle({
        center: new AMap.LngLat(110.572952,19.142443),// 圆心位置
        radius: 3000, //圆半径，单位:米
        fillColor: '#ff0000',   // 圆形填充颜色,使用16进制颜色代码赋值。默认值为#006600
        fillOpacity:0, //圆形填充透明度，取值范围[0,1]，0表示完全透明，1表示不透明。默认为0.9
    ...
    map.plugin(["AMap.GltfLoader"],function(){
        ...
        var urlCity = 'aaa.gltf';

        //var urlDuck = 'https://a.amap.com/jsapi_demos/static/gltf/Duck.gltf';
        var paramCity = {
            position: new AMap.LngLat(110.318632,20.038234), // 必须
            scale: 1, // 非必须，默认1, 设置模型缩放倍数
