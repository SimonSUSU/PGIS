...
function mapInit(){
    ...
    var map = new AMap.Map("container",{
        ...
        //rotation: 90,
        zoom: 18,//初始地图级别
        center: [110.369502,20.02657], //初始地图中心点
    ...
    var circle = new AMap.Circle({
        center: new AMap.LngLat(110.369502,20.02657),// 圆心位置
    ...
    map.plugin(["AMap.GltfLoader"],function(){
        ...
        var urlCity = '<?=FILE_PATH?>jwt.gltf';

        //var urlDuck = 'https://a.amap.com/jsapi_demos/static/gltf/Duck.gltf';
        var paramCity = {
            position: new AMap.LngLat(110.369502,20.02657), // 必须
