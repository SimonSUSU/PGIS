...
<ul>
    <?if($this->HCTL_url(array('area','add'))){?>
	<a href="javascript:;" onclick="openWin('<?=url(array('area','add'))?>', '90%','90%','添加');" class="right">添加</a>
    <?}?>
...
<table id="grid" class="easyui-datagrid" style="width:100%;height:100%;"
    ...
    <thead>
        <tr>
			<th field="title" align="left" width="60%">标题</th>
            <th field="add_time_str" align="center" width="150">发布时间</th>
			<th field="last_time_str" align="center" width="150">最后修改时间</th>
            <?if($this->HCTL_url(array('area','view'))){?>
                <th field="view_str" align="center" width="50">查看</th>
            <?}?>
